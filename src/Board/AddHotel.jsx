    ...
    return (
        ...
        border-0 border-b-2 border-gray-200 appearance-none dark:text-gray-400
            dark:border-gray-700 focus:outline-none focus:ring-0 focus:border-gray-200 peer">
                ...
                {/* file upload */}
                <div >
                    <label onClick={openPopup}  htmlFor="dropzone-file" className="flex flex-col items-center w-96 h-40 max-w-lg p-5 mx-auto mt-2 text-center bg-white border-2 border-gray-300 border-dashed cursor-pointer dark:bg-gray-900 dark:border-gray-700 rounded-xl">
