...
export default function AddItemPage() { 
    const { sectionName } = useParams(); // Get sectionName from URL
    return (
        <div className="overflow-x-auto bg-white p-10 ">
        <h2 className="text-2xl font-bold pb-4">Add {sectionName} Details</h2>
        <h3 className="text-xl font-thin pb-4">{sectionName} Management</h3>
        {/* Hotel Name */}
        <label
            htmlFor="UserEmail"
    ...
    border-0 border-b-2 border-gray-500  dark:text-gray-400
        dark:border-gray-700 focus:outline-none focus:ring-0 focus:border-gray-200 peer">
            ...
            <form >
                ...
                <label   className="flex flex-col items-center w-96 h-40 max-w-lg p-5 mx-auto mt-2 text-center bg-white border-2 border-gray-300 border-dashed cursor-pointer dark:bg-gray-900 dark:border-gray-700 rounded-xl">
