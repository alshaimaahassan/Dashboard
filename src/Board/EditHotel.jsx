export default function EditHotel() {
    return (
        ...
        <div className="overflow-x-auto bg-white p-10 ">
            <h2 className="text-2xl font-bold pb-4"> Edit Hotel Details</h2>
            <h3 className="text-xl font-thin pb-4">Hotel listing Management</h3>
            {/* Hotel Name */}
            <label
                htmlFor="HotelName"
            ...
            <div className="flex justify-between w-full gap-4">
                ...
                <select id="underline_select" className="py-2.5 px-0 w-full text-sm pt-8 mb-4 text-gray-600 bg-transparent 
                    border-0 border-b-2 border-gray-600 dark:text-gray-600
dark:border-gray-700 focus:outline-none focus:ring-0 focus:border-gray-200 peer ">
                    <option selected>Select category</option>

                    <option value="US">Select  category</option>
