      ...
      >
        {menuItems.map((item, index) => (
          <li key={index}>
            <Link
              to={item.href || '#'}
              className="flex font-thin items-center w-full p-1 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
            >
              {item.label || 'Untitled'}
            </Link>
          </li>
